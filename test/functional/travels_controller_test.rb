...
class TravelsControllerTest < ActionController::TestCase
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post :create, travel: { cost: @travel.cost, dest_city_id: @travel.dest_city_id, distance: @travel.distance, duration: @travel.duration, name: @travel.name, source_city_id: @travel.source_city_id }
    end
  ...
  test "should update travel" do
    put :update, id: @travel, travel: { cost: @travel.cost, dest_city_id: @travel.dest_city_id, distance: @travel.distance, duration: @travel.duration, name: @travel.name, source_city_id: @travel.source_city_id }
    assert_redirected_to travel_path(assigns(:travel))
  end
